    ...
    <div class="flex items-center mt-8">
        ...
        <div class="relative lg:inline-flex items-center bg-gray-100 rounded-xl">
            <div x-data="{ show: false}">
                ...
                <div x-show="show" @click.away="show = false" class="absolute mt-2 w-40 bg-gray-100 rounded-xl w-full z-50" style="display: none">
                  <a href="/" 
                    class="block py-1 px-4 hover:bg-blue-300 focus:bg-blue-500 hover:text-white focus:text-white"
                  >All</a>

                    @foreach ($categories as $category)
                    <a href="/categories/{{ $category->slug }}" 
                    class=
                    "block py-1 px-4 hover:bg-blue-300 focus:bg-blue-500 
